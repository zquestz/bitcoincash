/*jslint browser: true, devel: true, todo: true, regexp: false, vars: false */
/*global $ jQuery Granim google navigator window setTimeout document location smoothScroll twitterFetcher history console mr_parallax mr_variant grecaptcha */
...
mr = (function (mr, $, window, document) {
    ...
    mr.util.sortChildrenByText = function (parentElement, reverse) {
        ...
        items = $parentElement.children().get(),
        order = -1,
        order2 = 1;
...
mr = (function (mr, $, window, document) {
    ...
    mr.scroll.update = function (event) {
        ...
        if (mr.scroll.listeners.length > 0) {
            for (i = 0, l = mr.scroll.listeners.length; i < l; i = i + 1) {
...
mr = (function (mr, $, window, document) {
    ...
    mr.scroll.classModifiers.update = function (event) {
        ...
        while (l) {
            ...
            if (
                currentScroll > currentRule.scrollPoint &&
                !currentRule.hasClass
            ) {
...
mr = (function (mr, $, window, document) {
    ...
    mr.accordions.documentReady = function ($) {
        ...
        $(".accordion").each(function () {
            var accordion = $(this),
            minHeight = accordion.outerHeight(true);
    ...
    mr.accordions.activatePanel = function (panel, forceOpen) {
        ...
        if (li.hasClass("active")) {
            ...
            if (accordion.hasClass("accordion--oneopen")) {
                wasActive = accordion.find("li.active");
                if (wasActive.length) {
    ...
    mr.accordions.activatePanelById = function (id, forceOpen) {
        ...
        if (id !== "" && id !== "#") {
            panel = $(
                ".accordion > li > .accordion__title#" + id.replace("#", "")
            );
            if (panel.length) {
                $("html, body")
                    .stop(true)
    ...
    mr.cookies = {
        ...
        keys: function () {
            var aKeys = document.cookie
                ...
                .split(/\s*(?:\=[^;]*)?;\s*/),
                nLen, nIdx;
            for (nLen = aKeys.length, nIdx = 0; nIdx < nLen; nIdx = nIdx + 1) {
    ...
    mr.countdown.documentReady = function ($) {
        $(".countdown[data-date]").each(function () {
            var element = $(this),
                ...
                daysTextInit =
                    typeof element.attr("data-days-text") !== typeof undefined ? "%D " + element.attr("data-days-text") + " %H:%M:%S" : "%D days %H:%M:%S",
                daysText =
                    typeof mr.countdown.options.format !== typeof undefined ? mr.countdown.options.format : daysTextInit,
                dateFormat =
                    typeof element.attr("data-date-format") !== typeof undefined ? element.attr("data-date-format") : daysText,
                fallback;

            if (
                typeof element.attr("data-date-fallback") !== typeof undefined
            ) {
...
mr = (function (mr, $, window, document) {
    ...
    mr.dropdowns.repositionDropdowns = function ($) {
        $(".dropdown__container").each(function () {
            ...
            if (
                container.find('.dropdown__content:not([class*="md-12"])')
                    .length
            ) {
    ...
    mr.dropdowns.repositionDropdownsRtl = function ($) {
        ...
        $(".dropdown__content").each(function () {
            ...
            offset =
                windowWidth -
                (dropdown.offset().left + dropdown.outerWidth(true));
            width = dropdown.outerWidth(true);
            offsetRight = offset + width;
...
mr = (function (mr, $, window, document) {
    ...
    mr.forms.documentReady = function ($) {
        ...
        $('form[data-recaptcha-sitekey]:not([data-recaptcha-sitekey=""])').each(
            function () {
                ...
                widgetSize =
                    typeof widgetSize !== typeof undefined ? widgetSize : "";

                // Store the site key for later use
                mr.forms.captcha.sitekey = $thisForm.attr(
    ...
    mr.forms.submit = function (e) {
        ...
        var body = $("body"),
            ...
            formAction =
                typeof thisForm.attr("action") !== typeof undefined ? thisForm.attr("action") : "",
    ...
    mr.forms.validateFields = function (form) {
        ...
        form.find(".validate-required, .required, [required]")
        ...
        form.find('.validate-email, .email, [name*="cm-"][type="email"]').each(
            function () {
        ...
        if (!form.find(".field-error").length) {
            ...
            firstError = $(form).find(".field-error:first");
...
mr = (function (mr, $, window, document) {
    ...
    mr.instagram.documentReady = function ($) {
        ...
        if ($(".instafeed").length) {
            ...
            token = "4079540202.b9b1d8a.1d13c245c68d4a17bfbff87919aaeb14";
            client = "b9b1d8ae049d4153b24a6332f0088686";

            if ($(".instafeed[data-access-token][data-client-id]").length) {
                elementToken = $(
                    ".instafeed[data-access-token][data-client-id]"
                )
                    .first()
    ...
    mr.maps.initAPI = function ($) {
        ...
        if (
            ...
            if ($("[data-maps-api-key]").length) {
                ...
                apiKeyInit = $("[data-maps-api-key]:first").attr(
                    "data-maps-api-key"
                ),
                apiKey = typeof apiKey !== typeof undefined ? apiKeyInit : "";
                if (apiKey !== "") {
            ...
            if (typeof window.google.maps !== "undefined") {
                ...
                jQuery(".gmaps-active").each(function () {
                    var mapElement = this,
                        ...
                        isDraggable =
                            jQuery(document).width() > 766 ? true : false,
                        showZoomControl =
                            typeof mapInstance.attr("data-zoom-controls") !==
                            typeof undefined ? true : false,
                        zoomControlPos =
                            typeof mapInstance.attr("data-zoom-controls") !==
                            typeof undefined ? mapInstance.attr("data-zoom-controls") : false,
                        latlong =
                            typeof mapInstance.attr("data-latlong") !==
                            typeof undefined ? mapInstance.attr("data-latlong") : false,
                        latitude = latlong ? 1 * latlong.substr(0, latlong.indexOf(",")) : false,
                        longitude = latlong ? 1 * latlong.substr(latlong.indexOf(",") + 1) : false,
                        geocoder = new google.maps.Geocoder(),
                        address =
                            typeof mapInstance.attr("data-address") !==
                            typeof undefined ? mapInstance.attr("data-address").split(";") : [""],
                        map,
                        marker,
                        markerDefaults,
                        mapDefaults,
                    ...
                    mapAo.styles =
                        typeof mapInstance.attr("data-map-style") !==
                        typeof undefined ? JSON.parse(mapInstance.attr("data-map-style")) : undefined;
                    ...
                    (markerDefaults = {
                        icon: {
                            url:
                                (typeof mr_variant !== typeof undefined ? "../" : "") + "img/mapmarker.png",
                    ...
                    (markerAo.icon =
                        typeof mapInstance.attr("data-marker-image") !==
                        typeof undefined ? mapInstance.attr("data-marker-image") : undefined);
                    (markerAo.title = mapInstance.attr(
                        "data-marker-title"
                    ));
                                        ...
                                        if (
                                            ...
                                            marker = new google.maps.Marker(
                                                jQuery.extend(
                                                    {},
                                                    markerOptions,
                                                    { position: { lat: 1 * latlong[0], lng: 1 * latlong[1] }, map: map }
                                                )
                                            );
                                        } else if (
        ...
        $(document).on(
            ...
            function () {
                ...
                if (masonryFilter.attr("data-masonry-filter") !== "*") {
                    filterValue =
                        ".filter-" + masonryFilter.attr("data-masonry-filter");
                }
    ...
    mr.masonry.windowLoad = function () {
        $(".masonry").each(function () {
            ...
            if (masonryParent.is("[data-default-filter]")) {
                defaultFilter = masonryParent
                    .attr("data-default-filter")
                    .toLowerCase();
                defaultFilter = ".filter-" + defaultFilter;
                masonryParent
                    .find("li[data-masonry-filter]")
                    .removeClass("active");
                masonryParent
                    .find(
            ...
            masonry.isotope(
                jQuery.extend({}, themeDefaults, mr.masonry.options, ao)
            );
        });
    };
    ...
    mr.masonry.updateFilters = function (masonry) {
        ...
        $masonry.each(function () {
            var $masonry = $(this),
                ...
                filterAllText =
                    typeof filters.attr("data-filter-all-text") !==
                    typeof undefined ? filters.attr("data-filter-all-text") : "All",
                filtersList;
            ...
            if ($masonry.is(".masonry")) {
                ...
                if (
                    masonryContainer.find(".masonry__item[data-masonry-filter]")
                        .length
                ) {
...
mr = (function (mr, $, window, document) {
    ...
    mr.modals.documentReady = function ($) {
            ...
            if (modalContent.attr("data-width") !== undefined) {
                modalWidth =
                    modalContent
                        ...
                        .substr(
                            0,
                            modalContent.attr("data-width").indexOf("%")
                        ) * 1;
            ...
            if (modalContent.attr("data-height") !== undefined) {
                modalHeight =
                    modalContent
                        ...
                        .substr(
                            0,
                            modalContent.attr("data-height").indexOf("%")
                        ) * 1;
        ...
        $(".modal-instance").each(function (index) {
            ...
            modal = modalInstance.find(".modal-container"),
            modalContent = modalInstance.find(".modal-content"),
            trigger = modalInstance.find(".modal-trigger");
        ...
        $(".modal-trigger").on("click", function () {
            var modalTrigger = $(this), uniqueID, targetModal;
        ...
        $(".modal-container[data-autoshow]").each(function () {
            var modal = $(this),
            millisecondsDelay = modal.attr("data-autoshow") * 1;
            ...
            if ($(exitSelector).length) {
                ...
                jQuery(document).on("mouseleave", exitSelector, function () {
                    if (!$(".modal-active").length) {
                        if (
                            typeof modal.attr("data-cookie") !==
                            typeof undefined
                        ) {
                            if (
                                !mr.cookies.hasItem(modal.attr("data-cookie"))
                            ) {
        ...
        if (window.location.href.split("#").length === 2) {
            modalID = window.location.href.split("#").pop();
    ...
    mr.newsletters.documentReady = function ($) {
        ...
        $('form[action*="createsend.com"]').each(function () {
            ...
            if (!form.is(".form--no-placeholders")) {
                form.find("input:not([checkbox]):not([radio])").each(
                    function () {
                        var $input = $(this);
                        if (
            ...
            form.find('input[type="radio"]').wrap(
...
mr = (function (mr, $, window, document) {
    ...
    mr.notifications.documentReady = function ($) {
        ...
        $(".notification[data-autoshow]").each(function () {
            var notification = $(this),
            millisecondsDelay = parseInt(
                notification.attr("data-autoshow"),
                10
            );
        ...
        $("[data-notification-link]:not(.notification)").on(
            "click",
            function () {
                var notificationID = jQuery(this).attr(
    ...
    mr.notifications.showNotification = function (
        ...
        if (notification.is("[data-autohide]")) {
            hideDelay = parseInt(notification.attr("data-autohide"), 10);
            setTimeout(function () {
...
mr = (function (mr, $, window, document) {
    ...
    mr.parallax.documentReady = function ($) {
        ...
        if (windowWidth > 768) {
            parallaxHero = $(".parallax:nth-of-type(1)");
            parallaxHeroImage = $(
    ...
    mr.progressHorizontal.documentReady = function ($) {
        ...
        $(".progress-horizontal").each(function () {
            var bar = jQuery(this).find(".progress-horizontal__bar"),
                barObject = {},
                progress = jQuery(
                    '<div class="progress-horizontal__progress"></div>'
                );
...
mr = (function (mr, $, window, document) {
    ...
    mr.sliders.documentReady = function ($) {
        $(".slider").each(function (index) {
            var slider = $(this),
            sliderInitializer = slider.find("ul.slides"),
            childnum,
            themeDefaults,
            ao = {};

            sliderInitializer.find(">li").addClass("slide");
            childnum = sliderInitializer.find("li").length;
            ...
            ao.pageDots =
                ...
                sliderInitializer.find("li").length > 1 ? true : undefined;
            ao.prevNextButtons =
                slider.attr("data-arrows") === "true" ? true : undefined;
            ao.draggable =
                slider.attr("data-draggable") === "false" ? false : undefined;
            ao.autoPlay =
                slider.attr("data-autoplay") === "false" ? false : slider.attr("data-timing") ? parseInt(slider.attr("data-timing"), 10) : undefined;
            ao.accessibility =
                slider.attr("data-accessibility") === "false" ? false : undefined;
            ao.rightToLeft =
                slider.attr("data-rtl") === "true" ? true : undefined;
            ...
            $(sliderInitializer).on(
                "scroll.flickity",
                function (event, progress) {
                    if (
                        slider.find(".is-selected").hasClass("controls--dark")
                    ) {
...
mr = (function (mr, $, window, document) {
    ...
    mr.typed.documentReady = function ($) {
        $(".typed-text").each(function () {
            var text = $(this),
            strings = text.attr("data-typed-strings") ? text.attr("data-typed-strings").split(",") : [],
                themeDefaults = {
                    strings: [],
                    typeSpeed: 100,
                    loop: true,
            ...
            $(text).typed(
                jQuery.extend({}, themeDefaults, mr.typed.options, ao)
            );
        });
    };
        ...
        $(".tweets-feed")
            ...
            .each(function (index) {
                ...
                if (
                    ...
                    typeof element.attr("data-feed-name") !==
                        typeof undefined &&
                    ...
                    typeof mr.twitter.options.profile !== typeof undefined
                ) {
                    TweetConfig.profile = {
...
mr = (function (mr, $, window, document) {
    ...
    mr.video.documentReady = function ($) {
        ...
        $(".video-cover .video-play-icon").on("click", function () {
            var playIcon = $(this),
            videoCover = playIcon.closest(".video-cover"),
            video,
            iframe;
            if (videoCover.find("video").length) {
                video = videoCover.find("video").get(0);
                videoCover.addClass("reveal-video");
                video.play();
                return false;
            } else if (videoCover.find("iframe").length) {
                iframe = videoCover.find("iframe");
    ...
    mr.wizard.documentReady = function ($) {
        $(".wizard").each(function () {
            ...
            if (!wizard.is('[role="application"][id^="steps-uid"]')) {
                wizard.steps(
                    jQuery.extend({}, themeDefaults, mr.wizard.options)
                );
